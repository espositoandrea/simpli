...
\begin{frame}
	...
	\begin{columns}
		\column{0.4\textwidth}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=22, lastline=26]{Environment.hs}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=28, lastline=32]{Environment.hs}
		\column{0.6\textwidth}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=34, lastline=39]{Environment.hs}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=41, lastline=48]{Environment.hs}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\column{0.4\textwidth}
		\lstinputlisting[firstline=27,lastline=42]{Parser/Aexp.hs}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		\column{0.4\textwidth}
		\lstinputlisting[firstline=44,lastline=49]{Parser/Aexp.hs}
		\column{0.4\textwidth}
		\lstinputlisting[firstline=51,lastline=57]{Parser/Aexp.hs}
		\lstinputlisting[firstline=59,lastline=65]{Parser/Aexp.hs}
	\end{columns}
\end{frame}
...
\end{lstlisting}
		\column{0.45\textwidth}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=48,lastline=64]{Parser/Com.hs}
	\end{columns}
\end{frame}
...
\begin{frame}
	...
	\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=25,lastline=45]{Parser/Com.hs}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{columns}
		...
		\end{itemize}
		\column{0.45\textwidth}
		\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=66,lastline=79]{Parser/Com.hs}
\begin{lstlisting}[basicstyle=\ttfamily\tiny]
...
\begin{frame}[fragile]
	...
	\end{itemize}
	\lstinputlisting[basicstyle=\ttfamily\tiny,firstline=17,lastline=28]{Parser.hs}
\end{frame}
